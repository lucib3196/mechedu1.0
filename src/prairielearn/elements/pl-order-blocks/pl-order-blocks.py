...
import sys
pl_order_blocks_path = os.path.join(os.getcwd(), 'src','prairielearn', 'elements', 'pl-order-blocks')
...
def render(element_html: str, data: pl.QuestionData) -> str:
    ...
    if data["panel"] == "question":
        ...
        with open(ORDER_BLOCKS_MUSTACHE_TEMPLATE_NAME, "r", encoding="utf-8") as f:
